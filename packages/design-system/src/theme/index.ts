...
const lightPalette = {
  palette: {
    ...
    primary: {
      main: designTokens.color.light.schemes.primary,
      light: designTokens.color.light.primary[60],
      dark: designTokens.color.light.primary[30],
      contrastText: designTokens.color.light.schemes.onPrimary,
    ...
    secondary: {
      main: designTokens.color.light.schemes.secondary,
      light: designTokens.color.light.secondary[60],
      dark: designTokens.color.light.secondary[30],
      contrastText: designTokens.color.light.schemes.onSecondary,
    ...
    tertiary: {
      main: designTokens.color.light.schemes.tertiary,
      light: designTokens.color.light.tertiary[60],
      dark: designTokens.color.light.tertiary[30],
      contrastText: designTokens.color.light.schemes.onTertiary,
    ...
    error: {
      main: designTokens.color.light.schemes.error,
      light: designTokens.color.light.error[60],
      dark: designTokens.color.light.error[30],
      contrastText: designTokens.color.light.schemes.onError,
...
const darkPalette = {
  palette: {
    ...
    primary: {
      main: designTokens.color.dark.schemes.primary,
      light: designTokens.color.dark.primary[60],
      dark: designTokens.color.dark.primary[30],
      contrastText: designTokens.color.dark.schemes.onPrimary,
    ...
    secondary: {
      main: designTokens.color.dark.schemes.secondary,
      light: designTokens.color.dark.secondary[60],
      dark: designTokens.color.dark.secondary[30],
      contrastText: designTokens.color.dark.schemes.onSecondary,
    ...
    tertiary: {
      main: designTokens.color.dark.schemes.tertiary,
      light: designTokens.color.dark.tertiary[60],
      dark: designTokens.color.dark.tertiary[30],
      contrastText: designTokens.color.dark.schemes.onTertiary,
